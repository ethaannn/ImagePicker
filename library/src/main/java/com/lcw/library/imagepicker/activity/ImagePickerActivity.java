...
import com.ethan.imagepicker.R;
import com.ethan.imagepicker.util.PermissionUtil;
...
public class ImagePickerActivity extends BaseActivity implements ImagePickerAdapter.OnItemClickListener, ImageFoldersAdapter.OnImageFolderChangeListener {
    ...
    protected void getData() {
        //进行权限的判断
        boolean hasPermission = PermissionUtil.Companion.checkStorageAndCameraPermission(this);
        String[] permissions;
        if (Build.VERSION.SDK_INT>=Build.VERSION_CODES.TIRAMISU){
            permissions =new String[]{Manifest.permission.CAMERA,Manifest.permission.READ_MEDIA_IMAGES,Manifest.permission.VIBRATE,Manifest.permission.READ_MEDIA_AUDIO};
        }else {
