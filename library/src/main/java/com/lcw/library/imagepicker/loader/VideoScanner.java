...
public class VideoScanner extends AbsMediaScanner<MediaFile> {
    ...
    protected MediaFile parse(Cursor cursor) {
        ...
        Integer folderId = cursor.getInt(cursor.getColumnIndexOrThrow(MediaStore.Video.Media.BUCKET_ID));
        ...
        long dateToken = cursor.getLong(cursor.getColumnIndexOrThrow(MediaStore.Video.Media.DATE_TAKEN));
